module github.com/omniflow/omniflow
...
require (
	...
	// Pinned: later revisions switch to go.yaml.in/yaml/v4 and no longer build
	// against github.com/vmware-labs/yaml-jsonpath v0.3.2, which oapi-codegen needs.
